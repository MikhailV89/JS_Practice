...
function getCategoryPath(id, categories, products) {
    ...
    while (currentId) {
        const element = categories.find(item => item.id === currentId)
...
// console.log(getCategoryPath('c16', categories, products))
// console.log(getCategoryPath('c27', categories, products))
// console.log(getCategoryPath('c39', categories, products))
// console.log(getCategoryPath('p9', categories, products))
// console.log(getCategoryPath('p1', categories, products))
// console.log(getCategoryPath('c14', categories, products))
console.log(getCategoryPath('c32', categories, products))
// getCategoryPath('p1', categories, products) // ['Electronics', 'Phones', 'Smartphones']
// getCategoryPath('c14', categories, products) // []
// getCategoryPath('c32', categories, products) // ['Clothes']
